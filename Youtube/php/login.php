...
//echo "QUERYSTRING: ". $queryString. "\n";
	 $query = mysql_query($queryString, $db ); 
...
//echo "Salt From DB: ". $salt. "\n";
	
  //$PASSWORD = "pass";
// $salt = rand_string(48);
 //$PASSWORD = "password";
// echo "Salt From TEXT: ". $salt. "\n";
  $hashedPass = substr(pbkdf2(PBKDF2_HASH_ALGORITHM, $PASSWORD, $salt, PBKDF2_ITERATIONS, 48), 0, 50);

//echo "Hashed Pass: ". $hashedPass. "\n";
//echo "Hashed from DB: " . $hashFromDb;
	
	if(slow_equals($hashedPass, $hashFromDb))
	{
		echo 1;	
	}
  }
